      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
          ...
          <div className='flex flex-col'>
            ...
            <div className='rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden'>
              <img src={resultImage ? URL.createObjectURL(resultImage) : ''} alt="" />
              {
                !resultImage && image && <div className='absolute right-1/2 bottom-1/2 transform translate-y-1/2 translate-x-1/2'>
...

        {
          <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
            ...
            <a href={resultImage ? URL.createObjectURL(resultImage) : ''} download 
            className='px-8 py-2.5 text-white text-sm bg-gradient-to-r from-violet-600 to-fuchsia-500  rounded-full hover:scale-105 transition-all duration-700'>Download image</a>
          </div>
        }
      </div>
    </div>
